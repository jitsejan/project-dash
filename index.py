...
navbar = dbc.Navbar(
    dbc.Container(
        [
            ...
            dbc.Collapse(
                dbc.Nav(
                    [nav_items, dropdown], className="ml-auto", navbar=True
                ),
                id="navbar-collapse",
                navbar=True,
            ),
...
layout = html.Div([
    html.Div([
        ...
        dbc.Row(
            [
                dbc.Col(github.open_pulls_table),
            ],
            align="center",
        ),
        dbc.Row([
        ...
        dbc.Row(
            dbc.Col(html.H3(children='In progress', style={'textAlign': 'center',}),),
        ),
        dbc.Row(
            [
                dbc.Col(jira.open_issues_table),
            ],
            align="center",
        ),
        dbc.Row(
            dbc.Col(html.H3(children='In review', style={'textAlign': 'center',}),),
        ),
        dbc.Row(
            [
                dbc.Col(jira.review_issues_table),
            ],
            align="center",
        ),
        dbc.Row(
            [
                dbc.Col(html.H3(children='Todo', style={
                    'textAlign': 'center',
                }),),
            ],
            align="center",
        ...
        dbc.Row(
            [
                dbc.Col(jira.todo_issues_table),
            ],
            align="center",
        ),
    ])
...
def toggle_active_links(pathname):
    ...
    elif pathname == "/apps/jira":
        return [False, True, False]
    elif pathname == "/apps/github":
